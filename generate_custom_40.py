...
<head>
  ...
  <meta property="og:image" content="https://smartlifecalc.vercel.app/assets/pinterest-banner.png">

  <!-- Twitter Metadata -->
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="{c['title']}">
  <meta name="twitter:description" content="{c['meta_desc']}">
  <meta name="twitter:image" content="https://smartlifecalc.vercel.app/assets/pinterest-banner.png">
        ...
        <div class="calc-main-column">
          ...
          <article class="content-article">
            ...
            <div class="pinterest-share-card">
              ...
              <button class="pinterest-btn" onclick="shareToPinterest('https://smartlifecalc.vercel.app{c['url']}', 'https://smartlifecalc.vercel.app/assets/pinterest-banner.png', '{c['title']} — Free Calculator on SmartLifeCalc')">
